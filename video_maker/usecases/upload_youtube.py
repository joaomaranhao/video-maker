...
class UploadYoutube:
  def __init__(self, match_data: MatchData) -> None:
    ...
    self.__title = f"{match_data['mvp']['champion']} vs {match_data['loser']} - {match_data['region']} {match_data['mvp']['rank']} Patch {match_data['patch']}"
    ...
    """
    self.__category = "20"
    self.__keywords = [f"{match_data['mvp']['champion']}", "challenger", "leagueoflegends", "replay", "high kda", f"{match_data['region']}"]
    httplib2.RETRIES = 1
